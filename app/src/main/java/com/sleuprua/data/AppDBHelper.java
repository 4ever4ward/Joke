...
public class AppDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createJokesTableQuery = "CREATE TABLE "
                ...
                + AppDBContract.JokeEntry.COLUMN_JOKE_FAVOURITE + " INTEGER NOT NULL, "
                + AppDBContract.JokeEntry.COLUMN_JOKE_VOTE + " INTEGER NOT NULL " + " );";
        ...
        String createFavouritesTableQuery = "CREATE TABLE "
                ...
                + AppDBContract.FavouritesEntry.COLUMN_JOKE_FAVOURITE + " INTEGER NOT NULL, "
                + AppDBContract.FavouritesEntry.COLUMN_JOKE_VOTE + " INTEGER NOT NULL " + " );";
        ...
        String createDeferredOperationTableQuery = " CREATE TABLE "
                + AppDBContract.DeferredOperationEntry.TABLE_NAME + " ("
                + AppDBContract.DeferredOperationEntry.COLUMN_JOKE_ID + " INTEGER NOT NULL, "
                + AppDBContract.DeferredOperationEntry.COLUMN_OPERATION_ID + " INTEGER NOT NULL, "


                + " FOREIGN KEY (" + AppDBContract.DeferredOperationEntry.COLUMN_JOKE_ID + ") REFERENCES " +
                AppDBContract.JokeEntry.TABLE_NAME + " (" + AppDBContract.JokeEntry.COLUMN_ID + ") "
        ...
        db.execSQL(createDeferredOperationTableQuery);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + AppDBContract.DeferredOperationEntry.TABLE_NAME);
            onCreate(db);
        }
    }
