...
public final class AppDBContract {
    ...
    public static abstract class JokeEntry {
        ...
        public static String COLUMN_JOKE_FAVOURITE = "favourite";
        public static String COLUMN_JOKE_VOTE = "jused";
    }
    ...
    abstract static class DeferredOperationEntry implements BaseColumns {
        public static String TABLE_NAME = "deferred_operation";

        public static String COLUMN_JOKE_ID = "joke_ID";
        public static String COLUMN_OPERATION_ID = "operation_ID";
    }
}
